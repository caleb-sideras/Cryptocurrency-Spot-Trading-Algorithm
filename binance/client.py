...
class Client(object):
    ...
    # MARKET_ORDER_CRYPTO = ["MARKET", "quantity"]
    # MARKET_ORDER_USD = ["MARKET", "quoteOrderQty"]
    CRYPTO = "CRYPTO"
    USD = "USD"

    SYMBOL_BTCUSD = "BTCUSDT"
    SYMBOL_LINKUSD = "LINKUSDT"
    SYMBOL_ADAUSD = "ADAUSDT"
    SYMBOL_ALGOUSD = "ALGOUSDT"
    SYMBOL_DOTUSD = "DOTUSDT"
    SYMBOL_ICPUSD = "ICPUSDT"
    SYMBOL_MATIC = "MATICUSDT"
    SYMBOL_ETH = "ETHUSDT"
    SYMBOL_USDTUSDC = 'USDCUSDT'
